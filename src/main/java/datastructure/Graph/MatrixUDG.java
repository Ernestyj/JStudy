...
public class MatrixUDG {
    ...
    public MatrixUDG() {
        ...
        for (int i = 0; i < mVexs.length; i++) {
            System.out.printf("vertex(%dist): ", i);
            mVexs[i] = readChar();
        }
    ...
    public void prim(int start) {
        ...
        // 打印最小生成树
        System.out.printf("PRIM(%c)=%dist: ", mVexs[start], sum);
    ...
    public void kruskal() {
        ...
        for (int i=0; i<mEdgNum; i++) {
            ...
            // 如果m!=v，意味着"边i"与"已经添加到最小生成树中的顶点"没有形成环路
            if (m != n) {
        ...
        System.out.printf("Kruskal=%dist: ", length);
        for (int i = 0; i < index; i++)
    ...
    public void dijkstra(int vs, int[] prev, int[] dist) {
        ...
        for (int i=0; i < mVexs.length; i++)
            System.out.printf("  shortest(%c, %c)=%dist\n", mVexs[vs], mVexs[i], dist[i]);
    }
